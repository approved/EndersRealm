...
public class EndRuneParticle extends SpriteBillboardParticle {
    ...
    protected EndRuneParticle(World world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity,
            double zVelocity) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType type, World world, double xPos, double yPos, double zPos,
            ...
            EndRuneParticle endRuneParticle = new EndRuneParticle(world, xPos, yPos, zPos, xVelocity, yVelocity,
                    zVelocity);
